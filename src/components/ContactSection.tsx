        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16 animate-fade-in-up">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Looking for Web development or Mobile app solutions? Come talk
              about your project with me.
            </p>
          </div>
              ...
              >
                ...
                <div className="space-y-4">
                  {CONTACT_INFO.map((info, index) => {
                    ...
                    const IconComponent =
                      iconMap[info.title as keyof typeof iconMap];
              ...
              >
                ...
                <div className="bg-gradient-to-r from-purple-500/10 to-blue-500/10 p-6 rounded-lg border border-border">
                  ...
                  <p className="text-muted-foreground mb-4">
                    Available for Liferay CMS, React Native, and full-stack web
                    projects—let’s create impactful digital experiences.
                  </p>
